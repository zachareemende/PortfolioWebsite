      ...
      <a href="https://github.com/zachareemende/PortfolioWebsite">
        <div className="bg-slate-800 p-6 rounded-lg shadow h-80 overflow-hidden">
          <img
            ...
            className="h-44 w-auto mx-auto rounded"
          />
          <h2 className="mt-4 text-center">Check out the code for this <span className="text-yellow-300">mobile responsive</span> website!</h2>
